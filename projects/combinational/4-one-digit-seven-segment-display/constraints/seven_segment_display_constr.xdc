...
set_property PACKAGE_PIN V17 [get_ports decimal]
set_property PACKAGE_PIN W16 [get_ports {digit[1]}]
set_property PACKAGE_PIN V16 [get_ports {digit[0]}]
set_property PACKAGE_PIN R2 [get_ports {value[3]}]
